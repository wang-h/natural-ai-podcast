...
- 常用：(chuckle)、(breath)、(emm)、(sighs)、(laughs)
- 偶尔用：(coughs)、(inhale)、(exhale)、(sniffs)、(humming)
- 罕见：(clear-throat)、(groans)、(pant)、(gasps)、(snorts)、(burps)、(lip-smacking)、(hissing)、(sneezes)
...
- 允许的时间导演标记只有：[[interrupt=数字]]、[[overlap=数字]]、[[gap=数字]]
- interrupt/overlap 建议范围 120-700，gap 建议范围 80-500。超出范围请改回合理值。
- 时间导演标记只能放在说话内容开头，不能放在开头问候和结尾告别行。
- 允许的情绪标签只有：(laughs)、(chuckle)、(coughs)、(clear-throat)、(groans)、(breath)、(pant)、(inhale)、(exhale)、(gasps)、(sniffs)、(sighs)、(snorts)、(burps)、(lip-smacking)、(humming)、(hissing)、(emm)、(sneezes)
